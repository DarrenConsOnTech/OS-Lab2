...
#define SEPARATORS " \t\n"  // token sparators
#define MAX_TOKENS 10        // the command number
#define MAX_OPEN 10  //  open 10 stdin redirection files max and 10 stdout redirection files, myshell support several I/O redirections
